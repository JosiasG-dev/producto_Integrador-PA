namespace punto_de_venta_C_.Modelo
{
    public class CuentaPorPagar
    {
        ...
        public CuentaPorPagar(int id, Proveedor proveedor, int ordenId, double montoTotal, double pagado, double saldo, string vencimiento, Estado estado)
        {
            this.id = id;
        ...
        {
            return "OC-" + string.Format("{0:0000}", ordenId % 10000);
        }
    }
}
