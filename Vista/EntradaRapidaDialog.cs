...
{
    public class EntradaRapidaDialog : ContentPage
    {
        ...
        public EntradaRapidaDialog(Producto p, InventarioControlador ctrl)
        {
            this.ctrl = ctrl;
            this.producto = p;
            Title = "Entrada Rapida de Mercancia";
        ...
        private void construir()
        {
            ...
            var btnGuardar = Estilos.botonPrimario("Ingresar");
            btnGuardar.Clicked += (s, e) => intentarIngreso();
        ...
        private async void intentarIngreso()
        {
            try
            {
                ...
                await DisplayAlert("Éxito", "Inventario actualizado exitosamente", "OK");
                tcs.SetResult(true);
                await Navigation.PopModalAsync();
            }
            catch (Exception)
